...
data_config = {
    ...
    # directory for putting all preprocessed results for training to this path
    'preprocessed_data_dir': os.path.join(BASE, rf'C:\Users\test\Desktop\Leon\Datasets\TMH_Nodule-preprocess\nodulenet\preprocess_old'),
...
train_config = {
    ...
    'test_set_name': rf'C:\Users\test\Desktop\Leon\Projects\Slicer_modules\nodule_extension\slicer-plugin\tmh\4_val.csv',
...
# train_config['initial_checkpoint'] = r'300.pt' #train_config['out_dir'] + '/model/027.ckpt'
train_config['initial_checkpoint'] = r'300.ckpt' #train_config['out_dir'] + '/model/027.ckpt'
train_config['initial_checkpoint'] = r'C:\Users\test\Desktop\Leon\Projects\Model_deploy\checckpoint\4_train\model\300.ckpt' #train_config['out_dir'] + '/model/027.ckpt'
# train_config['initial_checkpoint'] = r'200.ckpt' #train_config['out_dir'] + '/model/027.ckpt'
# train_config['initial_checkpoint'] = r'D:\Leon\stuff\nodulenet\tmh\4_train\model\300.ckpt' #train_config['out_dir'] + '/model/027.ckpt'
